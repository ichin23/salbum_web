...
import { getQuickReviewComments, addQuickReviewComment } from '../../services/quickReviewService'
import type { QuickReviewCommentDTO } from '../../types'
...
const comments = ref<QuickReviewCommentDTO[]>([])
...
onMounted(async () => {
    try {
        comments.value = await getQuickReviewComments(props.reviewId)
    } catch (e) {
...
async function submitComment() {
    ...
    try {
        const created = await addQuickReviewComment(props.reviewId, content)
